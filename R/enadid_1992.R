#' National Survey of Demographic Dynamics 1992
#'
#' A dataset containing  attributes of the women and attributes of the children.
#'
#'
#' @format A data frame with 208002 rows and 12 variables
#'
#'
...
#'
#'
#' @source <https://www.inegi.org.mx/programas/enadid/1992/default.html#Microdatos>
#'
"enadid_1992"
